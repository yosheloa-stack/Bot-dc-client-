 ...
 * Busca e playlist usam a YouTube Data API (se configurada) e caem para
 * play-dl e youtube-sr como reforço.
 */
...
module.exports = { getPlayer, getOrCreatePlayer, resolve };
